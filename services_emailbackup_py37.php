...
function compile_python_script($source, $compiled) {
    ...
    $compile_command = "python3.7 -OO -c \"import py_compile; py_compile.compile('$source', cfile='$compiled')\"";
...
function run_python_script($pyc_file) {
    $command = "/usr/local/bin/python3.7 $pyc_file";
    $output = array();
    $return_var = 0;
...
// ==================================================
$feedback_message = "";
$cron_command = "/usr/local/bin/python3.7 /root/envia_email.pyc";
...
SCRIPT;
    ...
    if ($action === 'schedule') {
        ...
        $cron_entry = [
            ...
            'wday'   => $weekday,
            'who'    => 'root',
            'command'=> $cron_command,  // /usr/local/bin/python3.7 /root/envia_email.pyc
        ];
